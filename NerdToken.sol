...
|_| \_|_____|_| \_|____/
Tokenomics: 
4% Tax fee sent to holders.
4% Liquidity fee sent to pool.
1% Burn fee sent to address(0).
1% Marketing fee sent to 0x22aB06daC4161b6C29699b3416F73da4E72503a6.
1 Quadrillion Total Supply.
0.9 Quadrillion Max Burn.
*/
...
contract NERD is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**6 * 10**9;           // 1 Quadrillion Total Supply.
    ...
    address public marketingWallet = 0x22aB06daC4161b6C29699b3416F73da4E72503a6;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //If burnAddress has >= 0.9 Quadrillion
        //don't take burnFee
        if(balanceOf(address(0)) < 900000000 * 10**6 * 10**9){
